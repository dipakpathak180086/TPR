...
namespace TPR_App
{
    public partial class frmRptReprintHistory : Form
    {
        #region Variables
        ...
        private void btnGet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = oDal.ReprintHistory("SELECT", process, "", 0, "", ClsGlobal.UserId, dtpFromDate.Value.ToString("yyyy-MM-dd"), dtpToDate.Value.ToString("yyyy-MM-dd"));
