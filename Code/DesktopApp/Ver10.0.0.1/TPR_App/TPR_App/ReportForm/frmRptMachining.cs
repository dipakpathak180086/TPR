...
namespace TPR_App
{
    public partial class frmRptMachining : Form
    {
        #region Variables
        ...
        private void btnGet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = oDal.GetMachiningReportData(dtpFromDate.Text, dtpToDate.Text, ModelNo, txtLotNo.Text.Trim(),"0","1",LineNo);
                dgv.DataSource = dt;
                if (dt.Rows.Count > 0)
                {
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgv.Rows.Count > 0)
                {
                    ...
                    {
                        string ModelNo = cmbModelNo.SelectedIndex > 0 ? cmbModelNo.SelectedItem.ToString() : "";
                        DataTable dt = oDal.GetMachiningReportData(dtpFromDate.Text, dtpToDate.Text, ModelNo, txtLotNo.Text.Trim(), "0", "3");
