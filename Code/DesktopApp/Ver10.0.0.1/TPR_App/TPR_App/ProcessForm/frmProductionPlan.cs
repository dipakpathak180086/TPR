    ...
    public partial class frmProductionPlan : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidateInput())
                {
                    ...
                    oProdPlan.Remarks = txtRemarks.Text.Trim();
                    oProdPlan.LineNo = cmbLineNo.SelectedItem.ToString().Split('-')[0].Trim();
                    //If saving data
                    if (_IsUpdate == false)
                    {
                    ...
                    {
                        oProdPlan.LineNo = _SelectedLineNo;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_SelectedLineNo=="")
                {
                    ClsGlobal.SetInfoMessage("Line no details not found", lblMessage);
                    return;
                }
        ...
        private bool ValidateInput()
        {
            try
            {
                ...
                if (_IsUpdate == true)
                {
                    ...
                    {
                        ClsGlobal.SetInfoMessage("Please input remarks, why are you updating production plan!!", lblMessage);
                        txtRemarks.Focus();
                        return false;
                    }
                }
        ...
        private void dgv_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                _SelectedLineNo = dgv.Rows[e.RowIndex].Cells["LineNo"].Value.ToString();
